...
int64 nChainStartTime = 1402406662;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Aurum
    bool fStrictPayToScriptHash = true; // Always active in Aurum
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1402406674;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2385001;
        ...
        printf("block.nTime = %u \n", block.nTime);
        printf("block.nNonce = %u \n", block.nNonce);
        assert(block.hashMerkleRoot == uint256("0x1ad16e6d23739006e6eb021d797be82ea81fabefd51fb1853451293c187f587e"));
